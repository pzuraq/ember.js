...
CoreObject.toString = Mixin.prototype.toString;
CoreObject[NAME_KEY] = 'Ember.CoreObject';

CoreObject.prototype[POST_INIT] = function() {};
...
const _computedProperties = computed(function() {
  _hasCachedComputedProperties();
  let proto = this.proto();
  let property;
  let properties = [];
...
defineProperty(CoreObject, '_computedProperties', _computedProperties);

function injectedPropertyAssertion(debugContainerKey) {
...
if (DEBUG) {
  /**
    ...
    @method _onLookup
  */
  CoreObject._onLookup = injectedPropertyAssertion;
